class VendasManager {
    constructor() {
        this.apiUrl = "http://localhost:3000/vendas";
        this.vendas = [];
            ...
            <tr>
                ...
                <td>
                    <div class="flex space-x-2">
                        <button onclick="vendasManager.editVenda(${venda.id})" 
                                class="text-blue-600 hover:text-blue-800" title="Editar">
                            <i class="fas fa-edit w-4 h-4"></i>
                        </button>
                        <button onclick="vendasManager.deleteVenda(${venda.id})" 
    ...
    async saveVenda() {
        ...
        const totalVenda = this.produtosVenda.reduce((sum, produto) => sum + (produto.preco * produto.quantidade), 0);
        ...
        if (!vendaData.data || !vendaData.forma_pagamento || !vendaData.cliente_id) {
